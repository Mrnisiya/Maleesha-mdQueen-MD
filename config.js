...
global.ownername = process.env.OWNER_NAME === undefined ? "MͥR NAᷧDIYA ⷨ" : process.env.OWNER_NAME
let fake = process.env.OWNER_NUMBER === undefined ? '94729531658' : process.env.OWNER_NUMBER
global.owner = [`${fake}`]
